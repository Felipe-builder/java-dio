 ...
 * economizar tempo ele faz a lista de compras do supermercado em um aplicativo e costuma anotar cada item na mesma hora
...
public class ComprasNoSupermercado {
    public static void main(String[] args) {
        ...
        lista.forEach( linha -> System.out.println(Arrays.stream(linha.split(" "))
