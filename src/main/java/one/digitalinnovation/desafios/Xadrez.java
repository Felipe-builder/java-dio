...
/**
 * Desafio
 *      No tabuleiro de xadrez, a casa na linha 1, coluna 1 (canto superior esquerdo) é sempre branca e as
 *      cores das casas se alternam entre branca e preta, formando o formato tão conhecido como xadrez.
 ...
 *      inferior direito do tabuleiro, e para identificar, considere o inteiro 1 para a cor branca e 0 para
 *      a cor preta.
 */
public class Xadrez {
