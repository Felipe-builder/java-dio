...
public class ExempleTreeMap {
    public static void main(String[] args) {
        ...
        //Map<String, String> treeCapitais = new TreeMap<>(); não atende aos nossos requisitos por falta de métodos específicos
        ...
        //Retorna a primeira capital no top da árvore
        System.out.println(treeCapitais.firstKey());

        // Retorna a ultima capital na árvore
        ...
        //Imprime todas as capitais no console
        System.out.println(treeCapitais);
